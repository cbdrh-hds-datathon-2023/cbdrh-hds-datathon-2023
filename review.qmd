...
The first CBDRH Health Data Science datathon took place on Friday 26th July 2023. This event saw the participation of 22 HDS students working in six teams, five on campus and one hybrid online/on-campus team. The event focused on the [Antiretroviral Therapy in HIV dataset](data.qmd), and teams were challenged to pose a research question and develop a solution using their health context expertise and analytic skills.
